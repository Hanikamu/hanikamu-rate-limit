...
Hanikamu::RateLimit.configure do |config|
  ...
  # The adaptive limiter captures events for the Learning UI:
  #   - response_parser: captures any >= 400 status for user classification
  #   - error_classes: captures Ruby-level network errors (timeouts)
  # Rate changes happen only when the user classifies events in the Learning UI.
