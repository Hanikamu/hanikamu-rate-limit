...
module Hanikamu
  module RateLimit
    module Storage
      ...
      # historical rate chart showing how the adaptive algorithm learned.
      #
          ...
          def record!(registry_name, state)
            ...
            with_connection do
              RateSnapshot.create!(
                ...
                error_ceiling: snapshot[:error_ceiling],
                ceiling_hits: snapshot[:ceiling_hits].to_i,
                ceiling_confidence: snapshot[:ceiling_confidence].to_i,
                effective_cooldown: snapshot[:effective_cooldown]
              )
            end
